  ...
  <main class="flex flex-col justify-center p-6 pb-12">
    ...
    <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
      <form action="{{ route('login') }}" method="post" novalidate autocomplete="off">
        ...
        <div class="flex items-center justify-between mb-5">
          <div class="flex items-center gap-2">
            <input type="checkbox" name="remember" id="remember" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500" />
            <label for="remember" class="text-sm text-gray-900">Meni eslaysizmi</label>
          </div>
          <a href="forgot-password.html" class="text-sm font-medium text-green-600 hover:text-green-500">Parolni esdan chiqardingizmi?</a>
        </div>
      ...
      <!-- <div class="mt-6 flex items-center justify-center">
        <a href="" class="text-sm font-medium text-green-600 hover:text-green-500">Already have an account?</a>
      </div> -->
    </div>
  </main>
</body>
